...
ros::Publisher pub_keyframe_pointcloud2;
...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_keyframe_pointcloud2 = n.advertise<sensor_msgs::PointCloud2>("keyframe_pointcloud2", 1000);
...
void pubKeyframe(const Estimator &estimator)
{
    ...
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR && estimator.marginalization_flag == 0)
    {
        ...
        point_cloud2.header = point_cloud.header;
        ...
        point_cloud2.fields.resize(5);
        point_cloud2.fields[0].name = "x";
        point_cloud2.fields[0].offset = 0;
        point_cloud2.fields[0].datatype = sensor_msgs::PointField::FLOAT32;
        point_cloud2.fields[0].count = 1;
        point_cloud2.fields[1].name = "y";
        point_cloud2.fields[1].offset = 4;
        point_cloud2.fields[1].datatype = sensor_msgs::PointField::FLOAT32;
        point_cloud2.fields[1].count = 1;
        point_cloud2.fields[2].name = "z";
        point_cloud2.fields[2].offset = 8;
        point_cloud2.fields[2].datatype = sensor_msgs::PointField::FLOAT32;
        point_cloud2.fields[2].count = 1;
        point_cloud2.fields[3].name = "px";
        point_cloud2.fields[3].offset = 12;
        point_cloud2.fields[3].datatype = sensor_msgs::PointField::FLOAT32;
        point_cloud2.fields[3].count = 1;
        point_cloud2.fields[4].name = "py";
        point_cloud2.fields[4].offset = 16;
        point_cloud2.fields[4].datatype = sensor_msgs::PointField::FLOAT32;
        point_cloud2.fields[4].count = 1;

        point_cloud2.point_step = 20;
        ...
        sensor_msgs::PointCloud2Iterator<float> iter_px(point_cloud2, "px");
        sensor_msgs::PointCloud2Iterator<float> iter_py(point_cloud2, "py");

        for (std::size_t i=0 ; i < point_cloud.points.size() ; i++)
        {
            *iter_x = point_cloud.points[i].x;
            *iter_y = point_cloud.points[i].y;
            *iter_z = point_cloud.points[i].z;
            *iter_px = point_cloud.channels[i].values[2];
            *iter_py = point_cloud.channels[i].values[3];
        ...
        pub_keyframe_pointcloud2.publish(point_cloud2);

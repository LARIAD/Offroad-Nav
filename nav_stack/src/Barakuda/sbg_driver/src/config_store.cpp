...
void ConfigStore::loadOdomParameters(const ros::NodeHandle& ref_node_handle)
{
  ...
  ref_node_handle.param<std::string>("odometry/mapFrameId", odom_map_frame_id_ , "map");
  ref_node_handle.param<std::string>("odometry/initFrameId", odom_init_frame_id_ , "utm");
}
...
void ConfigStore::loadGnssParameters(const ros::NodeHandle& ref_node_handle)
{
  ...
  ref_node_handle.param<std::string>("gnss/primary_antenna_frame_id", primary_antenna_frame_id_, "sbg_ant1_apc");
  ref_node_handle.param<bool>("gnss/publish_primary_antenna_tf", publish_primary_antenna_tf_, false);
...
void ConfigStore::loadOutputFrameParameters(const ros::NodeHandle& ref_node_handle)
{
  ...
  ref_node_handle.param<std::string>("output/frame_id", frame_id_, use_enu_ ? "imu_link" : "imu_link_ned");
  ref_node_handle.param<bool>("output/publish_frame_tf", publish_frame_tf_, false);
}
...
const std::string &ConfigStore::getPrimaryAntennaFrameId() const
{
  return primary_antenna_frame_id_;
}

const bool &ConfigStore::getPublishPrimaryAntennaTF() const
{
  return publish_primary_antenna_tf_;
}
...
void ConfigStore::setRobotHeadingOffset(const tf2::Quaternion& q)
{
  robot_heading_offset_offset_ = q;
}

const tf2::Quaternion& ConfigStore::getRobotHeadingOffset() const
{
  return robot_heading_offset_offset_;
}
...
const bool &ConfigStore::getPublishFrameTF() const
{
  return publish_frame_tf_;
}
...
const std::string &ConfigStore::getOdomMapFrameId() const
{
  return odom_map_frame_id_;
}

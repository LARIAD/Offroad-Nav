...
class Parameter(Serializable):
    ...
    Attributes:
        ...
        channels_should_add_to_pcl_for_exec_fusion: blblal
                                    (Default: ``{"obli1": "0"}``)
    ...
    fusion_algorithms: list = field(
        default_factory=lambda: [
            ...
            "pointcloud_color",
            "pointcloud_csf_segmentation_gpu",
            "pointcloud_csf_segmentation",
            "pointcloud_csf_base_layer",
            
        ]
    )  # list of fusion algorithms
    pointcloud_channel_fusions: dict = field(default_factory=lambda: {"rgb": "color", "default": "'average'" })  # fusion for pointcloud channels
    channels_should_add_to_pcl_for_exec_fusion: dict = field(default_factory=lambda: {"obli1":"0"})
    ...
    weight_file: str = "/catkin_ws/src/elevation_mapping_cupy/elevation_mapping_cupy/config/core/weights.dat"  # weight file for traversability filter

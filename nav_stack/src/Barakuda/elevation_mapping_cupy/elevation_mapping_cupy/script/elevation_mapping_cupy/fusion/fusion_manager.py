...
class FusionManager(object):
    ...
    def register_plugin(self, plugin):
        ...
        """
        plugin_config_file = subprocess.getoutput('echo "' + self.params.plugin_config_file + '"')
        cfg = YAML().load(open(plugin_config_file, "r"))
        # print("module: ",plugin," found: ",importlib.util.find_spec(plugin, package="elevation_mapping_cupy.fusion"))
        try:
